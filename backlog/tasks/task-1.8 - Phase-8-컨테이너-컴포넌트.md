...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 src/features/stock/components/containers/StockChartContainer.tsx 생성 - 전체 기능 컨테이너
- [ ] #2 src/features/stock/components/containers/MiniStockChart.tsx 생성 - 대시보드용 미니 위젯
<!-- AC:END -->
